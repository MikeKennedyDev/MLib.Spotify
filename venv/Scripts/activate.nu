...
let virtual-env = "C:\Programming\Libraries\Python\MLib.Spotify\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Programming\Libraries\Python\MLib.Spotify\venv\Scripts\deactivate.nu"
